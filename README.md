...
### Datasets
- [files/bird_count_cleaned_may_29_2019.csv](bird_count_cleaned_may_29_2019.csv)
...
- [files/noaa_stations_2020_01_17.csv.gz](noaa_stations.csv)
  - list of all NOAA stations and their associated metadata.
  - This is pulled from the NOAA API
- [files/closest_station_2020_01_20.csv.gz](output.csv)
...
- [files/cbc_weather_effort_1900-2018.csv](cbc_weather_effort_1900-2018.csv)
